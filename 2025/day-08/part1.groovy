...
// this seems rather horrific but....
// get the unique values from the index as a list
solution = new ArrayList(new HashSet(circuits.values()))

// sort the circuits, largest first
solution.sort{a, b -> return b.size() - a.size()}

// multiply the size of the three largest circuits
// together to find the answer
answer = 1;
for (int i = 0 ; i < 3 ; ++i)
	answer = answer * solution[i].size()
